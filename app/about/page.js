        ...
        <div className="w-full max-w-4xl p-8 bg-white text-black border-2 border-black relative hover:bg-gray-200 dark:bg-gray-800 dark:text-white dark:border-none shadow-lg rounded-lg hover:scale-105 transition-all duration-300 dark:hover:bg-gray-900">
          <div className="flex flex-col items-center">
            <div className="w-full flex flex-col justify-center mx-auto">
              <h1 className="text-5xl font-extrabold text-gray-800 dark:text-white mb-6 text-center">About Me</h1>
      ...
      <section className="py-16 dark:bg-gray-800 dark:text-white">
        <div className="max-w-7xl mx-auto my-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white">Shayan's Journey as a Coder</h2>
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                <h3 className="text-3xl font-extrabold text-gray-800 dark:text-white">TypeScript</h3>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                <h3 className="text-3xl font-extrabold text-gray-800 dark:text-white">Node JS</h3>
                <hr className="border-t border-gray-300 my-2" />
                <p className="mt-4 text-gray-600 dark:text-gray-50">
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                <h3 className="text-3xl font-extrabold text-gray-800 dark:text-white">FullStack Development with Next.js</h3>
                <hr className="border-t border-gray-300 my-2" />
                <p className="mt-4 text-gray-600 dark:text-gray-50">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                <h3 className="text-3xl font-extrabold text-gray-800 dark:text-white">Giving Back</h3>
                <hr className="border-t border-gray-300 my-2" />
                <p className="mt-4 text-gray-600 dark:text-gray-50">
